...
| `PivotTable`   | `onRendererUpdate` <br /> function               | (none, optional)              | function called every time the renderer is updated. For Plotly renderers see `onUpdate` of [React Plotly](https://github.com/plotly/react-plotly.js#user-content-basic-props).                                                                              |
