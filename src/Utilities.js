...
const numberFormat = function(opts_in) {
    ...
    return function(x) {
        ...
        const result = addSeparators((opts.scaler * x).toFixed(opts.digitsAfterDecimal),
            opts.thousandsSep, opts.decimalSep);
        ...
        return function([attr]) {
            return function() {
                return {
                    ...
                    value() {
                        if (mode === 'mean') {
                            if (this.n === 0) { return 0 / 0; } return this.m;
                        }
    ...
    fractionOf(wrapped, type = 'total', formatter = usFmtPct) {
        return (...x) => function(data, rowKey, colKey) {
            return {
                ...
                push(record) { this.inner.push(record); },
                format: formatter,
                value() { return this.inner.value() /
