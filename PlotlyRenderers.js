...
function createPlotlyRenderers(PlotlyComponent) {
  return {
    'Gráfico de Colunas Agrupadas': makeRenderer(PlotlyComponent, { type: 'bar' }, { barmode: 'group' }),
    'Gráfico de Colunas Empilhadas': makeRenderer(PlotlyComponent, { type: 'bar' }, { barmode: 'relative' }),
    'Gráfico de Barras Agrupadas': makeRenderer(PlotlyComponent, { type: 'bar', orientation: 'h' }, { barmode: 'group' }, true),
    'Gráfico de Barras Empilhadas': makeRenderer(PlotlyComponent, { type: 'bar', orientation: 'h' }, { barmode: 'relative' }, true),
    ...
    'Gráfico de Setores': makeRenderer(PlotlyComponent, { type: 'pie', scalegroup: 1, hoverinfo: 'label+value', textinfo: 'none' }, {}, true)
  };
}
